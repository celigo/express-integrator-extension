...
var errors = require('./express-integrator-extension/lib/errors')
var extension = require('./express-integrator-extension/lib/extension')
...
function callFunction (req, res, next) {
  ...
  logger.info(`logName=requestDetails, traceId=${req.body.traceId}, reqId=${req.body._reqId}`)
